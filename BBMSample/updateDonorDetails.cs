...
namespace BBMSample
{
    ...
    public partial class updateDonorDetails : Form
    {
        ...
        {
            String query =" update newDonor set dname='" + txtName.Text + "',fname='" + txtFather.Text + "',mname='" + txtMother.Text + "',dob='" + txtDOB.Text + "',mobile=" + txtMobile.Text + ",gender='" + txtGender.Text + "',email='" + txtEmail.Text + "',bloodgroup='" + txtBloodGroup.Text + "',city='" + txtCity.Text + "',dadress='" + txtAdress.Text + "' where did="+txtDonorID.Text+" ";
            fn.setData(query);
